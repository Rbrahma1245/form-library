...
const PlainText = (props) => {
    ...
    const { isTextHtmlString = false, text = "", classNames = "", nativeProps, disabled } = fieldProps;
    return (React.createElement(React.Fragment, null, isTextHtmlString && typeof text === "string" ? (React.createElement("div", { className: clsx(classNames), dangerouslySetInnerHTML: { __html: text } })) : (React.createElement("div", { className: clsx("plaintext-field", classNames), disabled: disabled, ...nativeProps }, text))));
};
...
const MLFormBuilder = (props) => {
    ...
    return (React.createElement("form", { onSubmit: formikProps.handleSubmit, className: "form" },
